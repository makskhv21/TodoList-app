...
function HomePage() {
    ...
    const insightsData = {
        'productivity-hacks': {
            ...
            content: 'Learn proven strategies to increase your daily productivity. From the Pomodoro Technique to task batching, discover new ways to stay focused and get more done in less time.',
            image: photoProductivity
        },
        'time-management': {
            title: 'Time Management Mastery',
            content: 'Understand how to effectively manage your time by prioritizing tasks and minimizing distractions. Our expert advice will help you make the most of your hours and achieve more.',
            image: photoTime
        },
        'workflow-optimization': {
            title: 'Workflow Optimization',
            content: 'Optimize your daily workflow with tips on task automation and seamless collaboration tools. Learn how to automate repetitive tasks and reduce friction in your work routine.',
            image: photoPrioritization
        },
        'success-stories': {
            title: 'Success Stories',
            content: 'Get inspired by stories from people who have transformed their work and life through better task management. Learn from their experiences and apply their tips to your own life.',
                ...
                <section className='homepage-main-features'>
                    ...
                    <div className='homepage-main-features-grid'>
                        <div className='feature-card'>
                            <img src={iconManagement} alt='Task Management' className='feature-image' />
                            <h2>Task Management</h2>
                            <p>Create and organize tasks effortlessly with our intuitive interface.</p>
                        </div>

                        <div className='feature-card'>
                            <img src={iconCallendar} alt='Calendar Integration' className='feature-image' />
                            <h2>Calendar Integration</h2>
                            <p>Sync your tasks with your calendar to never miss a deadline.</p>
                        </div>

                        <div className='feature-card'>
                            <img src={iconCollaboration} alt='Collaboration' className='feature-image' />
                            <h2>Collaboration</h2>
                            <p>Share tasks with your team and work together more efficiently and seamlessly.</p>
                        </div>
                    </div>
                </section>
                ...
                <section className='homepage-main-insights'>
                    ...
                    <div className="insight-nav">
                        <a
                            ...
                            className={selectedInsight === 'productivity-hacks' ? 'active' : ''}
                        >
                            Productivity Hacks
                        </a>
                        <a
                        ...
                        <a
                            ...
                            className={selectedInsight === 'workflow-optimization' ? 'active' : ''}
                        >
                            Workflow Optimization
                        </a>
                        <a
                    ...
                    <div className="insight-content">
                        <div className="insight-image">
                            <img src={insightsData[selectedInsight].image} alt={insightsData[selectedInsight].title} />
                        </div>
                    ...
                    <div className="testimonials-cards">
                        <div className="testimonial-card">
                            ...
                            <div className="testimonial-content">
                                <p className="testimonial-quote">"TodoList has truly changed my workflow. It helps me prioritize tasks and stay organized in a simple and effective way!"</p>
                        ...
                        <div className="testimonial-card">
                            ...
                            <div className="testimonial-content">
                                <p className="testimonial-quote">"This tool is a game-changer for my team. Task sharing and collaboration have never been easier!"</p>
            ...
            <footer className="homepage-footer">
                <div className="footer-content">
                    <div className="footer-about">
                        ...
                        <p>TodoList is a comprehensive task management platform designed to help you organize, prioritize, and achieve your goals with ease.</p>
                    </div>

                    <div className="footer-contact">
                        <h2>Contact Us</h2>
                        <p>Email: <a href="mailto:support@todolist.com">support@todolist.com</a></p>
